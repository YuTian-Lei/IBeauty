					...
					<ul>
						<li class="login_warp">
							<ul>
								...
								%>
								<li class="pli"><a href="../personal.do" title=""
									id="login_href" target="_top">${user}</a>
									...
									<div class="xianshii">
										<table>
											<tr>
												...
												<td class="wdd2">
													<div class="wth1">
														<a href="../personal.do" target="_top">个人首页</a>
													</div>
													<div class="wth1">
														<a href="../myorder.do" target="_top">我的订单</a>
													</div>
													<div class="wth1">
														<a href="../mycollect.do" target="_top">我的收藏</a>
													</div>
													<div class="wth1">
														<a href="../findComment.do" target="_top">我的评价</a>
													</div>
												</td>
											</tr>
										</table>
								...
								%>
								<li><a href="../login.jsp" title="立即登录" id="login_href"
									target="_top">马上登录</a></li>
								<li class="line"><span>|</span></li>
								<li><a href="../regist.jsp" id="register_href" title="马上注册"
									target="_top">立即注册</a></li>
								<%
									}
								%>
							</ul>
					...
					<div class="cart">
						<ul>
							<li class="bag-li"><a href="../refresh.do" class="shopbag"
								target="_top"> <span><img src="../static/img/gwc.png" /></span>
									<span class="cart_hover">购物袋 <%
										if (session.getAttribute("user") == null
 ...
 %> (<em>${cartcount.num}</em>) </span> <span>：</span> <span class="bag_precie">￥${cartcount.price}</span>
										...
										<div class="mycart_box">
											...
											<ul class="list">
												<c:forEach var="cart" items="${list1}">
													<li><div class="pic fl">
															<a target="_blank"
																href="../toDetail.do?productid=${cart.productId}"><img
														...
														<div class="title fr">
															...
															<p class="other">
																<span class="money">￥${cart.productPrice}元</span>&nbsp;<i
																	id="####${cart.id}">×&nbsp;${cart.productNum}</i><a
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$(".topNav").find("a").attr("target", "_self");
			$(".top_search").find("a").attr("target", "_self");
